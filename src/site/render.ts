...
.site-head{display:flex;align-items:center;gap:14px;max-width:1400px;margin:0 auto;
  padding:18px clamp(20px,5vw,80px);border-bottom:1px solid var(--line)}
...
/* ---------- home feed ---------- */
.feed{max-width:1400px;margin:0 auto;padding:40px clamp(20px,5vw,80px) 80px}
...
/* ---------- article ---------- */
.post{max-width:1400px;margin:0 auto;padding:24px clamp(20px,5vw,80px) 96px}
